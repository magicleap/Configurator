...
namespace Microsoft.MixedReality.Toolkit.SpatialManipulation
{
    /// <summary>
    /// *** IMPORTANT ***
    /// THIS IS AN ALTERED VERSION OF MRTK OBJECT MANIPULATOR
    /// The base objectmanipulator does not allow for dragging logic
    /// So we added it ourselves
    /// 
    ...
    /// give better results.
    /// </remarks>
    [RequireComponent(typeof(UGUIInputAdapterDraggable))]
    [RequireComponent(typeof(ConstraintManager))]
    [AddComponentMenu("MRTK/Spatial Manipulation/Draggable Object Manipulator")]
    public class DraggableObjectManipulator : StatefulInteractable
    {
        #region Public Enums
        ...
        [SerializeField] private float dragInteractionTime = 0.6f;
        /// <inheritdoc />
        ...
        protected override void OnSelectExited(SelectExitEventArgs args)
        {
            using (OnSelectExitedPerfMarker.Auto())
            {
                ...
                UIManager.Instance.CurrentConfigurable.IsBeingManipulated = false;
            }
        }
        ...
        public void ResetDragTimer(bool shouldStartTimer = false)
        {
            timer = 0;
        }
        ...
        public override void ProcessInteractable(XRInteractionUpdateOrder.UpdatePhase updatePhase)
        {
            ...
            using (ObjectManipulatorProcessInteractableMarker.Auto())
            {
                ...
                UIManager.Instance.CurrentConfigurable.IsBeingManipulated = true;
    ...
    public static class ReleaseBehaviorTypeExtensions
    {
        ...
        public static bool IsMaskSet(this DraggableObjectManipulator.ReleaseBehaviorType a, DraggableObjectManipulator.ReleaseBehaviorType b)
        {
            return ((a & b) == b);
        }
    }
